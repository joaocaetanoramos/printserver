...
MSG_INST_STEP_IP="Fixando o IP atual (não muda mais no reboot; use PS_NO_STATIC_IP=1 para pular)..."
MSG_INST_DONE="  Instalação concluída!"
MSG_INST_CUPS_URL="CUPS:  http://localhost:631  (ou http://IP-DO-SERVIDOR:631)"
MSG_INST_ACCESS="Acesse o CUPS de outro computador da rede:"
...
MSG_WIFI_NM_MISSING="NetworkManager não está instalado. Rode o instalador uma vez (ps-update) para instalar."
...
MSG_IP_DHCP_OK="De volta a DHCP — o IP agora vem do roteador."
MSG_IP_LINKLOCAL="! Recusando fixar IP link-local/loopback. Confira a rede primeiro."
